...
namespace Smooth.Slinq.Collections {
	...
	public class Lookup<K, T> : IDisposable {
		...
		/// Ownership of the lookup and any values it contains is retained by the caller.
		/// </summary>
		public Slinq<U, GroupJoinContext<U, K, T, T2, C2>> GroupJoinAndKeep<U, T2, C2>(Slinq<T2, C2> outer, Fn<T2, K> outerSelector, Fn<T2, Slinq<T, LinkedContext<T>>, U> resultSelector) {
		...
		/// Ownership of the lookup and any values it contains is retained by the caller.
		/// </summary>
		public Slinq<U, GroupJoinContext<U, K, T, T2, C2, P>> GroupJoinAndKeep<U, T2, C2, P>(Slinq<T2, C2> outer, Fn<T2, P, K> outerSelector, Fn<T2, Slinq<T, LinkedContext<T>>, P, U> resultSelector, P parameter) {
		...
		/// </summary>
		public Slinq<U, GroupJoinContext<U, K, T, T2, C2>> GroupJoinAndDispose<U, T2, C2>(Slinq<T2, C2> outer, Fn<T2, K> outerSelector, Fn<T2, Slinq<T, LinkedContext<T>>, U> resultSelector) {
		...
		/// When the enumeration is complete, the lookup and any values it contains are added to the disposal queue.
		/// </summary>
		public Slinq<U, GroupJoinContext<U, K, T, T2, C2, P>> GroupJoinAndDispose<U, T2, C2, P>(Slinq<T2, C2> outer, Fn<T2, P, K> outerSelector, Fn<T2, Slinq<T, LinkedContext<T>>, P, U> resultSelector, P parameter) {
		...
		/// Ownership of the lookup and any values it contains is retained by the caller.
		/// </summary>
		public Slinq<U, JoinContext<U, K, T, T2, C2>> JoinAndKeep<U, T2, C2>(Slinq<T2, C2> outer, Fn<T2, K> outerSelector, Fn<T2, T, U> resultSelector) {
		...
		/// Ownership of the lookup and any values it contains is retained by the caller.
		/// </summary>
		public Slinq<U, JoinContext<U, K, T, T2, C2, P>> JoinAndKeep<U, T2, C2, P>(Slinq<T2, C2> outer, Fn<T2, P, K> outerSelector, Fn<T2, T, P, U> resultSelector, P parameter) {
		...
		/// When the enumeration is complete, the lookup and any values it contains are added to the disposal queue.
		/// </summary>
		public Slinq<U, JoinContext<U, K, T, T2, C2>> JoinAndDispose<U, T2, C2>(Slinq<T2, C2> outer, Fn<T2, K> outerSelector, Fn<T2, T, U> resultSelector) {
		...
		/// When the enumeration is complete, the lookup and any values it contains are added to the disposal queue.
		/// </summary>
		public Slinq<U, JoinContext<U, K, T, T2, C2, P>> JoinAndDispose<U, T2, C2, P>(Slinq<T2, C2> outer, Fn<T2, P, K> outerSelector, Fn<T2, T, P, U> resultSelector, P parameter) {
