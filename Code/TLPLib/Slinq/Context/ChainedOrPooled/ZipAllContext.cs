...
namespace Smooth.Slinq.Context {
	...
	public struct ZipAllContext<T2, C2, T, C> {
		...
		public static Slinq<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> ZipAll(Slinq<T, C> left, Slinq<T2, C2> right, ZipRemoveFlags removeFlags) {
			return new Slinq<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>>(
				skip,
				remove,
				dispose,
		...
		private static readonly Mutator<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> skip = Skip;
		private static readonly Mutator<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> remove = Remove;
		private static readonly Mutator<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> dispose = Dispose;
		
		private static void Skip(ref ZipAllContext<T2, C2, T, C> context, out Option<Tpl<Option<T>, Option<T2>>> next) {
			...
			if (context.left.current.isSome || context.right.current.isSome) {
				next = new Option<Tpl<Option<T>, Option<T2>>>(new Tpl<Option<T>, Option<T2>>(context.left.current, context.right.current));
			} else {
				next = new Option<Tpl<Option<T>, Option<T2>>>();
			}
		...
		private static void Remove(ref ZipAllContext<T2, C2, T, C> context, out Option<Tpl<Option<T>, Option<T2>>> next) {
			context.bd.DetectBacktrack();
		...
		private static void Dispose(ref ZipAllContext<T2, C2, T, C> context, out Option<Tpl<Option<T>, Option<T2>>> next) {
			next = new Option<Tpl<Option<T>, Option<T2>>>();
	...
	public struct ZipAllContext<U, T2, C2, T, C> {
		...
		public static Slinq<U, ZipAllContext<U, T2, C2, T, C>> ZipAll(Slinq<T, C> left, Slinq<T2, C2> right, Fn<Option<T>, Option<T2>, U> selector, ZipRemoveFlags removeFlags) {
		...
		private Slinq<T, C> left;
		private Slinq<T2, C2> right;
		private readonly Fn<Option<T>, Option<T2>, U> selector;
		private readonly ZipRemoveFlags removeFlags;
		...
		private ZipAllContext(Slinq<T, C> left, Slinq<T2, C2> right, Fn<Option<T>, Option<T2>, U> selector, ZipRemoveFlags removeFlags) {
			this.needsMove = false;
			this.left = left;
			this.right = right;
	...
	public struct ZipAllContext<U, T2, C2, T, C, P> {
		...
		public static Slinq<U, ZipAllContext<U, T2, C2, T, C, P>> ZipAll(Slinq<T, C> left, Slinq<T2, C2> right, Fn<Option<T>, Option<T2>, P, U> selector, P parameter, ZipRemoveFlags removeFlags) {
		...
		private Slinq<T, C> left;
		private Slinq<T2, C2> right;
		private readonly Fn<Option<T>, Option<T2>, P, U> selector;
		...
		private ZipAllContext(Slinq<T, C> left, Slinq<T2, C2> right, Fn<Option<T>, Option<T2>, P, U> selector, P parameter, ZipRemoveFlags removeFlags) {
			this.needsMove = false;
			this.left = left;
			this.right = right;
			this.selector = selector;
