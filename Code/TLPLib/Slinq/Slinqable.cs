...
namespace Smooth.Slinq {
	...
	public static class Slinqable {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Tpl<T, int>, IListContext<T>> SlinqWithIndex<T>(this IList<T> list, int startIndex, int step) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Tpl<T, int>, IListContext<T>> SlinqWithIndex<T>(this IList<T> list) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Tpl<T, int>, IListContext<T>> SlinqWithIndex<T>(this IList<T> list, int startIndex) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Tpl<T, int>, IListContext<T>> SlinqWithIndexDescending<T>(this IList<T> list) {
		...
		/// Slinqs created by this method will chain removal operations to the underlying list.
		/// </summary>
		public static Slinq<Tpl<T, int>, IListContext<T>> SlinqWithIndexDescending<T>(this IList<T> list, int startIndex) {
			return IListContext<T>.SlinqWithIndex(list, startIndex, -1);
		}
		...
		/// Slinqs created by this method do not support element removal.
		/// </summary>
		public static Slinq<T, FuncContext<T>> Sequence<T>(T seed, Fn<T, T> selector) {
		...
		/// Slinqs created by this method do not support element removal.
		/// </summary>
		public static Slinq<T, FuncContext<T, P>> Sequence<T, P>(T seed, Fn<T, P, T> selector, P parameter) {
		...
		/// Slinqs created by this method do not support element removal.
		/// </summary>
		public static Slinq<T, FuncOptionContext<T>> Sequence<T>(T seed, Fn<T, Option<T>> selector) {
		...
		/// Slinqs created by this method do not support element removal.
		/// </summary>
		public static Slinq<T, FuncOptionContext<T, P>> Sequence<T, P>(T seed, Fn<T, P, Option<T>> selector, P parameter) {
