...
namespace Smooth.Slinq {
	...
	public struct Slinq<T, C> {
		...
		/// </summary>
		public Slinq<T, C> SkipWhile(Fn<T, bool> predicate) {
			while (current.isSome && predicate(current.get)) {
				skip(ref context, out current);
			}
			return this;
		}
		...
		/// After perfoming this operation, the Slinq will be positioned on the first element for which the predicate returns false.
		/// </summary>
		public Slinq<T, C> SkipWhile<P>(Fn<T, P, bool> predicate, P parameter) {
			while (current.isSome && predicate(current.get, parameter)) {
				skip(ref context, out current);
			}
			return this;
		}
		...
		/// </summary>
		public U SkipWhile<U>(U seed, Fn<U, T, Option<U>> selector) {
			while (current.isSome) {
				var next = selector(seed, current.get);
				if (next.isSome) {
					skip(ref context, out current);
					seed = next.get;
				} else {
		...
		/// After perfoming this operation, the Slinq will be positioned on the first element for which the selector returns None.
		/// </summary>
		public U SkipWhile<U, P>(U seed, Fn<U, T, P, Option<U>> selector, P parameter) {
			while (current.isSome) {
				var next = selector(seed, current.get, parameter);
				if (next.isSome) {
					skip(ref context, out current);
					seed = next.get;
				} else {
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public int RemoveAll(Act<T> then) {
			var count = 0;
			while (current.isSome) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed);
				++count;
			}
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public int RemoveAll<P>(Act<T, P> then, P thenParameter) {
			var count = 0;
			while (current.isSome) {
				var removed = current.get;
				remove(ref context, out current);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> Remove(int count, Act<T> then) {
			while (current.isSome && count-- > 0) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> Remove<P>(int count, Act<T, P> then, P thenParameter) {
			while (current.isSome && count-- > 0) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed, thenParameter);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> RemoveWhile(Fn<T, bool> predicate) {
			while (current.isSome && predicate(current.get)) {
				remove(ref context, out current);
			}
			return this;
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> RemoveWhile(Fn<T, bool> predicate, Act<T> then) {
			while (current.isSome && predicate(current.get)) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> RemoveWhile<P>(Fn<T, bool> predicate, Act<T, P> then, P thenParameter) {
			while (current.isSome && predicate(current.get)) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed, thenParameter);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> RemoveWhile<P>(Fn<T, P, bool> predicate, P parameter) {
			while (current.isSome && predicate(current.get, parameter)) {
				remove(ref context, out current);
			}
			return this;
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> RemoveWhile<P>(Fn<T, P, bool> predicate, P parameter, Act<T> then) {
			while (current.isSome && predicate(current.get, parameter)) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public Slinq<T, C> RemoveWhile<P, P2>(Fn<T, P, bool> predicate, P parameter, Act<T, P2> then, P2 thenParameter) {
			while (current.isSome && predicate(current.get, parameter)) {
				var removed = current.get;
				remove(ref context, out current);
				then(removed, thenParameter);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public U RemoveWhile<U>(U seed, Fn<U, T, Option<U>> selector) {
			while (current.isSome) {
				var next = selector(seed, current.get);
				if (next.isSome) {
					remove(ref context, out current);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public U RemoveWhile<U>(U seed, Fn<U, T, Option<U>> selector, Act<T> then) {
			while (current.isSome) {
				var next = selector(seed, current.get);
				if (next.isSome) {
					var removed = current.get;
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public U RemoveWhile<U, P>(U seed, Fn<U, T, Option<U>> selector, Act<T, P> then, P thenParameter) {
			while (current.isSome) {
				var next = selector(seed, current.get);
				if (next.isSome) {
					var removed = current.get;
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public U RemoveWhile<U, P>(U seed, Fn<U, T, P, Option<U>> selector, P parameter) {
			while (current.isSome) {
				var next = selector(seed, current.get, parameter);
				if (next.isSome) {
					remove(ref context, out current);
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public U RemoveWhile<U, P>(U seed, Fn<U, T, P, Option<U>> selector, P parameter, Act<T> then) {
			while (current.isSome) {
				var next = selector(seed, current.get, parameter);
				if (next.isSome) {
					var removed = current.get;
		...
		/// </summary>
		/// <exception cref="NotSupportedException">The Slinq or an underlying Slinq in the chain does not support element removal.</exception>
		public U RemoveWhile<U, P, P2>(U seed, Fn<U, T, P, Option<U>> selector, P parameter, Act<T, P2> then, P2 thenParameter) {
			while (current.isSome) {
				var next = selector(seed, current.get, parameter);
				if (next.isSome) {
					var removed = current.get;
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public T Aggregate(Fn<T, T, T> selector) {
			return AggregateOrNone(selector).getOrElse(() => { throw new InvalidOperationException(); });
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> AggregateOrNone(Fn<T, T, T> selector) {
			if (current.isSome) {
				var acc = current.get;
				skip(ref context, out current);
				while (current.isSome) {
					acc = selector(acc, current.get);
					skip(ref context, out current);
				}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> AggregateOrNone<P>(Fn<T, T, P, T> selector, P parameter) {
			if (current.isSome) {
				var acc = current.get;
				skip(ref context, out current);
				while (current.isSome) {
					acc = selector(acc, current.get, parameter);
					skip(ref context, out current);
				}
				return new Option<T>(acc);
			} else {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public U Aggregate<U>(U seed, Fn<U, T, U> selector) {
			while (current.isSome) {
				seed = selector(seed, current.get);
				skip(ref context, out current);
			}
			return seed;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public V Aggregate<U, V>(U seed, Fn<U, T, U> selector, Fn<U, V> resultSelector) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public U Aggregate<U, P>(U seed, Fn<U, T, P, U> selector, P parameter) {
			while (current.isSome) {
				seed = selector(seed, current.get, parameter);
				skip(ref context, out current);
			}
			return seed;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public U AggregateWhile<U>(U seed, Fn<U, T, Option<U>> selector) {
			while (current.isSome) {
				var next = selector(seed, current.get);
				if (next.isSome) {
					skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public U AggregateWhile<U, P>(U seed, Fn<U, T, P, Option<U>> selector, P parameter) {
			while (current.isSome) {
				var next = selector(seed, current.get, parameter);
				if (next.isSome) {
					skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public bool All(Fn<T, bool> predicate) {
			while (current.isSome) {
				if (!predicate(current.get)) {
					dispose(ref context, out current);
					return false;
				}
				skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public bool All<P>(Fn<T, P, bool> predicate, P parameter) {
			while (current.isSome) {
				if (!predicate(current.get, parameter)) {
					dispose(ref context, out current);
					return false;
				}
				skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public bool Any(Fn<T, bool> predicate) {
			while (current.isSome) {
				if (predicate(current.get)) {
					dispose(ref context, out current);
					return true;
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public bool Any<P>(Fn<T, P, bool> predicate, P parameter) {
			while (current.isSome) {
				if (predicate(current.get, parameter)) {
					dispose(ref context, out current);
					return true;
		...
		public bool Contains(T value, IEqualityComparer<T> comparer) {
			while (current.isSome) {
				if (comparer.Equals(value, current.get)) {
					dispose(ref context, out current);
					return true;
				}
				skip(ref context, out current);
		...
		public T ElementAt(int index) {
			return ElementAtOrNone(index).getOrElse(() => { throw new ArgumentOutOfRangeException(); });
		}
		...
		public T ElementAtOrDefault(int index) {
			return ElementAtOrNone(index).get;
		}
		...
		/// </summary>
		public T First() {
			return FirstOrNone().getOrElse(() => { throw new InvalidOperationException(); });
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public T First(Fn<T, bool> predicate) {
			return FirstOrNone(predicate).getOrElse(() => { throw new InvalidOperationException(); });
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public T FirstOrDefault(Fn<T, bool> predicate) {
			return FirstOrNone(predicate).get;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> FirstOrNone(Fn<T, bool> predicate) {
			while (current.isSome && !predicate(current.get)) {
				skip(ref context, out current);
			}
			return FirstOrNone();
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> FirstOrNone<P>(Fn<T, P, bool> predicate, P parameter) {
			while (current.isSome && !predicate(current.get, parameter)) {
				skip(ref context, out current);
			}
			return FirstOrNone();
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public void ForEach(Act<T> action) {
			while (current.isSome) {
				action(current.get);
				skip(ref context, out current);
			}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public void ForEach<P>(Act<T, P> action, P parameter) {
			while (current.isSome) {
				action(current.get, parameter);
				skip(ref context, out current);
			}
		}
		...
		/// </summary>
		public T Last() {
			return LastOrNone().getOrElse(() => { throw new InvalidOperationException(); });
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public T Last(Fn<T, bool> predicate) {
			return LastOrNone(predicate).getOrElse(() => { throw new InvalidOperationException(); });
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public T LastOrDefault(Fn<T, bool> predicate) {
			return LastOrNone(predicate).get;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> LastOrNone(Fn<T, bool> predicate) {
			var last = Option<T>.None;
			while (current.isSome) {
				if (predicate(current.get)) {
					last = current;
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> LastOrNone<P>(Fn<T, P, bool> predicate, P parameter) {
			var last = Option<T>.None;
			while (current.isSome) {
				if (predicate(current.get, parameter)) {
					last = current;
		...
		public Option<T> MaxOrNone(Comparison<T> comparison) {
			if (current.isSome) {
				...
				skip(ref context, out current);
				while (current.isSome) {
					if (comparison(value, current.get) < 0) {
						value = current.get;
					}
					skip(ref context, out current);
				}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MaxOrNone<K>(Fn<T, K> selector) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MaxOrNone<K>(Fn<T, K> selector, IComparer<K> comparer) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MaxOrNone<K>(Fn<T, K> selector, Comparison<K> comparison) {
			if (current.isSome) {
				var key = selector(current.get);
				var value = current.get;
				skip(ref context, out current);
				while (current.isSome) {
					var currentKey = selector(current.get);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MaxOrNone<K, P>(Fn<T, P, K> selector, P parameter) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MaxOrNone<K, P>(Fn<T, P, K> selector, P parameter, IComparer<K> comparer) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MaxOrNone<K, P>(Fn<T, P, K> selector, P parameter, Comparison<K> comparison) {
			if (current.isSome) {
				var key = selector(current.get, parameter);
				var value = current.get;
				skip(ref context, out current);
				while (current.isSome) {
					var currentKey = selector(current.get, parameter);
					if (comparison(key, currentKey) < 0) {
						key = currentKey;
						value = current.get;
					}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MinOrNone<K>(Fn<T, K> selector) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MinOrNone<K>(Fn<T, K> selector, IComparer<K> comparer) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MinOrNone<K>(Fn<T, K> selector, Comparison<K> comparison) {
			if (current.isSome) {
				var key = selector(current.get);
				var value = current.get;
				skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MinOrNone<K, P>(Fn<T, P, K> selector, P parameter) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MinOrNone<K, P>(Fn<T, P, K> selector, P parameter, IComparer<K> comparer) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Option<T> MinOrNone<K, P>(Fn<T, P, K> selector, P parameter, Comparison<K> comparison) {
			if (current.isSome) {
				var key = selector(current.get, parameter);
				var value = current.get;
				skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public bool SequenceEqual<T2, C2>(Slinq<T2, C2> other, Fn<T, T2, bool> predicate) {
			while (current.isSome && other.current.isSome) {
				if (predicate(current.get, other.current.get)) {
					skip(ref context, out current);
		...
		/// </summary>
		public T Single() {
			return SingleOrNone().getOrElse(() => { throw new InvalidOperationException(); });
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Tpl<LinkedHeadTail<T>, LinkedHeadTail<T>> SplitRight(int count) {
			if (current.isSome) {
				if (count > 0) {
					var left = new LinkedHeadTail<T>();
					var right = new LinkedHeadTail<T>(current.get);
					
					skip(ref context, out current);
					
					while (current.isSome && right.count <= count) {
						right.tail.next = Linked<T>.Borrow(current.get);
					...
					return new Tpl<LinkedHeadTail<T>, LinkedHeadTail<T>>(left, right);
				} else {
					return new Tpl<LinkedHeadTail<T>, LinkedHeadTail<T>>(ToLinked(), new LinkedHeadTail<T>());
				}
			} else {
				return new Tpl<LinkedHeadTail<T>, LinkedHeadTail<T>>();
			}
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public IC AddTo<U, IC>(IC collection, Fn<T, U> selector) where IC : ICollection<U> {
			while (current.isSome) {
				collection.Add(selector(current.get));
				skip(ref context, out current);
			}
			return collection;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Disposable<IC> AddTo<U, IC>(Disposable<IC> collection, Fn<T, U> selector) where IC : ICollection<U> {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public IC AddTo<U, IC, P>(IC collection, Fn<T, P, U> selector, P parameter) where IC : ICollection<U> {
			while (current.isSome) {
				collection.Add(selector(current.get, parameter));
				skip(ref context, out current);
			}
			return collection;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Disposable<IC> AddTo<U, IC, P>(Disposable<IC> collection, Fn<T, P, U> selector, P parameter) where IC : ICollection<U> {
		...
		public LinkedHeadTail<T> AddTo(LinkedHeadTail<T> list) {
			if (current.isSome) {
				list.Append(current.get);
				skip(ref context, out current);
				
				while (current.isSome) {
					list.tail.next = Linked<T>.Borrow(current.get);
		...
		public LinkedHeadTail<T> AddToReverse(LinkedHeadTail<T> list) {
			if (current.isSome) {
				var ht = new LinkedHeadTail<T>(current.get);
				skip(ref context, out current);
				
				while (current.isSome) {
					var node = Linked<T>.Borrow(current.get);
					node.next = ht.head;
					ht.head = node;
					++ht.count;
					skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> AddTo<K>(LinkedHeadTail<K, T> list, Fn<T, K> selector) {
			if (current.isSome) {
				list.Append(selector(current.get), current.get);
				skip(ref context, out current);
				
				while (current.isSome) {
					list.tail.next = Linked<K, T>.Borrow(selector(current.get), current.get);
					list.tail = list.tail.next;
					++list.count;
					skip(ref context, out current);
				}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> AddTo<K, P>(LinkedHeadTail<K, T> list, Fn<T, P, K> selector, P parameter) {
			if (current.isSome) {
				list.Append(selector(current.get, parameter), current.get);
				skip(ref context, out current);
				
				while (current.isSome) {
					list.tail.next = Linked<K, T>.Borrow(selector(current.get, parameter), current.get);
					list.tail = list.tail.next;
					++list.count;
					skip(ref context, out current);
				}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> AddToReverse<K>(LinkedHeadTail<K, T> list, Fn<T, K> selector) {
			if (current.isSome) {
				var ht = new LinkedHeadTail<K, T>(selector(current.get), current.get);
				skip(ref context, out current);
				
				while (current.isSome) {
					var node = Linked<K, T>.Borrow(selector(current.get), current.get);
					node.next = ht.head;
					ht.head = node;
					++ht.count;
					skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> AddToReverse<K, P>(LinkedHeadTail<K, T> list, Fn<T, P, K> selector, P parameter) {
			if (current.isSome) {
				var ht = new LinkedHeadTail<K, T>(selector(current.get, parameter), current.get);
				skip(ref context, out current);
				
				while (current.isSome) {
					var node = Linked<K, T>.Borrow(selector(current.get, parameter), current.get);
					node.next = ht.head;
					ht.head = node;
					++ht.count;
					skip(ref context, out current);
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Lookup<K, T> AddTo<K>(Lookup<K, T> lookup, Fn<T, K> selector) {
			while (current.isSome) {
				lookup.Add(selector(current.get), current.get);
				skip(ref context, out current);
			}
			return lookup;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Lookup<K, T> AddTo<K, P>(Lookup<K, T> lookup, Fn<T, P, K> selector, P parameter) {
			while (current.isSome) {
				lookup.Add(selector(current.get, parameter), current.get);
				skip(ref context, out current);
			}
			return lookup;
		}
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> ToLinked<K>(Fn<T, K> selector) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> ToLinked<K, P>(Fn<T, P, K> selector, P parameter) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> ToLinkedReverse<K>(Fn<T, K> selector) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public LinkedHeadTail<K, T> ToLinkedReverse<K, P>(Fn<T, P, K> selector, P parameter) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Lookup<K, T> ToLookup<K>(Fn<T, K> selector, IEqualityComparer<K> comparer) {
		...
		/// This operation will consume and dispose the Slinq.
		/// </summary>
		public Lookup<K, T> ToLookup<K, P>(Fn<T, P, K> selector, P parameter, IEqualityComparer<K> comparer) {
	...
	public static class Slinq {
		...
		/// </summary>
		public static Slinq<U, AggregateContext<U, T, C>> AggregateRunning<U, T, C>(this Slinq<T, C> slinq, U seed, Fn<U, T, U> selector) {
		...
		/// Returns a chained Slinq that performs a running aggegatation over the specified Slinq.
		/// </summary>
		public static Slinq<U, AggregateContext<U, T, C, P>> AggregateRunning<U, T, C, P>(this Slinq<T, C> slinq, U seed, Fn<U, T, P, U> selector, P parameter) {
		...
		/// Analog to Enumerable.Distinct().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C>> Distinct<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector) {
		...
		/// Analog to Enumerable.Distinct().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C>> Distinct<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Distinct().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C, P>> Distinct<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter) {
		...
		/// Analog to Enumerable.Distinct().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C, P>> Distinct<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Except().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C>> Except<K, C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, K> selector) {
		...
		/// Analog to Enumerable.Except().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C>> Except<K, C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, K> selector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Except().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C, P>> Except<K, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, P, K> selector, P parameter) {
		...
		/// Analog to Enumerable.Except().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C, P>> Except<K, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, P, K> selector, P parameter, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.GroupBy().
		/// </summary>
		public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> GroupBy<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.GroupBy().
		/// </summary>
		public static Slinq<Grouping<K, T, LinkedContext<T>>, GroupByContext<K, T>> GroupBy<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.GroupJoin(), with removal operations chained to the outer Slinq.
		/// </summary>
		public static Slinq<U, GroupJoinContext<U, K, T2, T, C>> GroupJoin<U, K, T2, C2, T, C>(this Slinq<T, C> outer, Slinq<T2, C2> inner, Fn<T, K> outerSelector, Fn<T2, K> innerSelector, Fn<T, Slinq<T2, LinkedContext<T2>>, U> resultSelector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.GroupJoin(), with removal operations chained to the outer Slinq.
		/// </summary>
		public static Slinq<U, GroupJoinContext<U, K, T2, T, C, P>> GroupJoin<U, K, T2, C2, T, C, P>(this Slinq<T, C> outer, Slinq<T2, C2> inner, Fn<T, P, K> outerSelector, Fn<T2, P, K> innerSelector, Fn<T, Slinq<T2, LinkedContext<T2>>, P, U> resultSelector, P parameter, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Intersect().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C>> Intersect<K, C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, K> selector) {
		...
		/// Analog to Enumerable.Intersect().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C>> Intersect<K, C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, K> selector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Intersect().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C, P>> Intersect<K, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, P, K> selector, P parameter) {
		...
		/// Analog to Enumerable.Intersect().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, C, P>> Intersect<K, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, P, K> selector, P parameter, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Join(), with removal operations chained to the outer Slinq.
		/// </summary>
		public static Slinq<U, JoinContext<U, K, T2, T, C>> Join<U, K, T2, C2, T, C>(this Slinq<T, C> outer, Slinq<T2, C2> inner, Fn<T, K> outerSelector, Fn<T2, K> innerSelector, Fn<T, T2, U> resultSelector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Join(), with removal operations chained to the outer Slinq.
		/// </summary>
		public static Slinq<U, JoinContext<U, K, T2, T, C, P>> Join<U, K, T2, C2, T, C, P>(this Slinq<T, C> outer, Slinq<T2, C2> inner, Fn<T, P, K> outerSelector, Fn<T2, P, K> innerSelector, Fn<T, T2, P, U> resultSelector, P parameter, IEqualityComparer<K> comparer) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, IComparer<K> comparer) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, Comparison<K> comparison) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, IComparer<K> comparer) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, Comparison<K> comparison) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C>(this Slinq<T, C> slinq, Fn<T, K> selector, Comparison<K> comparison, bool ascending) {
			return slinq.current.isSome ?
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, IComparer<K> comparer) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, Comparison<K> comparison) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, IComparer<K> comparer) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderByDescending<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, Comparison<K> comparison) {
		...
		/// Note: The Slinq API does not provide methods for ThenBy() orderings, to sort by multiple values in succession you should supply a composite key and/or comparision.
		/// </summary>
		public static Slinq<T, LinkedContext<K, T>> OrderBy<K, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, K> selector, P parameter, Comparison<K> comparison, bool ascending) {
			return slinq.current.isSome ?
		...
		/// </summary>
		public static Slinq<U, SelectContext<U, T, C>> Select<U, T, C>(this Slinq<T, C> slinq, Fn<T, U> selector) {
		...
		/// Analog to Enumerable.Select().
		/// </summary>
		public static Slinq<U, SelectContext<U, T, C, P>> Select<U, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, U> selector, P parameter) {
		...
		/// </summary>
		public static Slinq<U, SelectSlinqContext<U, UC, T, C>> SelectMany<U, UC, T, C>(this Slinq<T, C> slinq, Fn<T, Slinq<U, UC>> selector) {
		...
		/// Analog to Enumerable.SelectMany().
		/// </summary>
		public static Slinq<U, SelectSlinqContext<U, UC, T, C, P>> SelectMany<U, UC, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, Slinq<U, UC>> selector, P parameter) {
		...
		/// Analog to Enumerable.SelectMany().
		/// </summary>
		public static Slinq<U, SelectOptionContext<U, T, C>> SelectMany<U, T, C>(this Slinq<T, C> slinq, Fn<T, Option<U>> selector) {
		...
		/// Analog to Enumerable.SelectMany().
		/// </summary>
		public static Slinq<U, SelectOptionContext<U, T, C, P>> SelectMany<U, T, C, P>(this Slinq<T, C> slinq, Fn<T, P, Option<U>> selector, P parameter) {
		...
		/// </summary>
		public static Slinq<T, PredicateContext<T, C>> TakeWhile<T, C>(this Slinq<T, C> slinq, Fn<T, bool> predicate) {
		...
		/// Analog to Enumerable.TakeWhile().
		/// </summary>
		public static Slinq<T, PredicateContext<T, C, P>> TakeWhile<T, C, P>(this Slinq<T, C> slinq, Fn<T, P, bool> predicate, P parameter) {
		...
		/// </summary>
		public static Slinq<T, PredicateContext<T, C>> Where<T, C>(this Slinq<T, C> slinq, Fn<T, bool> predicate) {
		...
		/// Analog to Enumerable.Where().
		/// </summary>
		public static Slinq<T, PredicateContext<T, C, P>> Where<T, C, P>(this Slinq<T, C> slinq, Fn<T, P, bool> predicate, P parameter) {
		...
		/// Analog to Enumerable.Union().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, ConcatContext<C2, T, C>>> Union<K, C2, T, C>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, K> selector, IEqualityComparer<K> comparer) {
		...
		/// Analog to Enumerable.Union().
		/// </summary>
		public static Slinq<T, HashSetContext<K, T, ConcatContext<C2, T, C>, P>> Union<K, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T, C2> other, Fn<T, P, K> selector, P parameter, IEqualityComparer<K> comparer) {
			return slinq.Concat(other).Distinct(selector, parameter, comparer);
		}
		
		/// <summary>
		/// Analog to Enumerable.Zip() that combines elements into Tpls and chains removal operations to the left Slinq.
		/// </summary>
		public static Slinq<Tpl<T, T2>, ZipContext<T2, C2, T, C>> Zip<T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with) {
			return ZipContext<T2, C2, T, C>.Zip(slinq, with, ZipRemoveFlags.Left);
		}
		
		/// <summary>
		/// Analog to Enumerable.Zip() that combines elements into Tpls and chains removal operations to the the specified Slinq(s).
		/// </summary>
		public static Slinq<Tpl<T, T2>, ZipContext<T2, C2, T, C>> Zip<T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, ZipRemoveFlags removeFlags) {
		...
		/// </summary>
		public static Slinq<U, ZipContext<U, T2, C2, T, C>> Zip<U, T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<T, T2, U> selector) {
		...
		/// </summary>
		public static Slinq<U, ZipContext<U, T2, C2, T, C>> Zip<U, T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<T, T2, U> selector, ZipRemoveFlags removeFlags) {
		...
		/// Analog to Enumerable.Zip() that chains removal operations to the left Slinq.
		/// </summary>
		public static Slinq<U, ZipContext<U, T2, C2, T, C, P>> Zip<U, T2, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<T, T2, P, U> selector, P parameter) {
		...
		/// Analog to Enumerable.Zip() that chains removal operations to the specified Slinq(s).
		/// </summary>
		public static Slinq<U, ZipContext<U, T2, C2, T, C, P>> Zip<U, T2, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<T, T2, P, U> selector, P parameter, ZipRemoveFlags removeFlags) {
			return ZipContext<U, T2, C2, T, C, P>.Zip(slinq, with, selector, parameter, removeFlags);
		}

		/// <summary>
		/// Returns a Slinq that combines the corresponding elements from the supplied Slinqs into Tpls and chains removal operations to the left Slinq.
		/// 
		/// The returned Slinq will continue enumerating until it reaches the end of the longer of the supplied Slinqs.
		/// 
		/// While a Slinq has elements remaining, the enumerated Tpls will contain Some options containing the corresponding elements from the Slinq in the corresponding position.
		///
		/// If either of the Slinqs is empty while the other still has elements remaining, the enumerated Tpls will contain None options in place of the shorter Slinq's element until the enumeration is complete.
		/// 
		/// Removal operations will not be chained to an empty Slinq.
		/// </summary>
		public static Slinq<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> ZipAll<T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with) {
			return ZipAllContext<T2, C2, T, C>.ZipAll(slinq, with, ZipRemoveFlags.Left);
		}
		
		/// <summary>
		/// Returns a Slinq that combines the corresponding elements from the supplied Slinqs into Tpls and chains removal operations to the specified Slinq(s).
		/// 
		/// The returned Slinq will continue enumerating until it reaches the end of the longer of the supplied Slinqs.
		/// 
		/// While a Slinq has elements remaining, the enumerated Tpls will contain Some options containing the corresponding elements from the Slinq in the corresponding position.
		...
		/// Removal operations will not be chained to an empty Slinq.
		/// </summary>
		public static Slinq<Tpl<Option<T>, Option<T2>>, ZipAllContext<T2, C2, T, C>> ZipAll<T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, ZipRemoveFlags removeFlags) {
		...
		/// Removal operations will not be chained to an empty Slinq.
		/// </summary>
		public static Slinq<U, ZipAllContext<U, T2, C2, T, C>> ZipAll<U, T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<Option<T>, Option<T2>, U> selector) {
		...
		/// Removal operations will not be chained to an empty Slinq.
		/// </summary>
		public static Slinq<U, ZipAllContext<U, T2, C2, T, C>> ZipAll<U, T2, C2, T, C>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<Option<T>, Option<T2>, U> selector, ZipRemoveFlags removeFlags) {
		...
		/// Removal operations will not be chained to an empty Slinq.
		/// </summary>
		public static Slinq<U, ZipAllContext<U, T2, C2, T, C, P>> ZipAll<U, T2, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<Option<T>, Option<T2>, P, U> selector, P parameter) {
		...
		/// Removal operations will not be chained to an empty Slinq.
		/// </summary>
		public static Slinq<U, ZipAllContext<U, T2, C2, T, C, P>> ZipAll<U, T2, C2, T, C, P>(this Slinq<T, C> slinq, Slinq<T2, C2> with, Fn<Option<T>, Option<T2>, P, U> selector, P parameter, ZipRemoveFlags removeFlags) {
		...
		/// </summary>
		public static Slinq<Tpl<T, int>, ZipContext<int, FuncContext<int, int>, T, C>> ZipWithIndex<T, C>(this Slinq<T, C> slinq) {
		...
		public static Double Average<C>(this Slinq<Int32, C> slinq) {
			return AverageOrNone(slinq).getOrElse(() => { throw new InvalidOperationException(); });
		}
