...
namespace Smooth.Slinq.Context {
	public struct FuncContext<T> {
		...
		public static Slinq<T, FuncContext<T>> Sequence(T seed, Fn<T, T> selector) {
		...
		private T acc;
		private readonly Fn<T, T> selector;
		
		#pragma warning disable 0414
		private BacktrackDetector bd;
		#pragma warning restore 0414

		private FuncContext(T seed, Fn<T, T> selector) {
	...
	public struct FuncContext<T, P> {
		...
		public static Slinq<T, FuncContext<T, P>> Sequence(T seed, Fn<T, P, T> selector, P parameter) {
		...
		private bool needsMove;
		private T acc;
		private readonly Fn<T, P, T> selector;
		...
		private FuncContext(T seed, Fn<T, P, T> selector, P parameter) {
			this.needsMove = false;
			this.acc = seed;
			this.selector = selector;
